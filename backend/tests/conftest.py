...
def client(tmp_path, monkeypatch):
    ...
    # players.py did `from backend.api.videos import storage_root, video_store`,
    # which bound its own module-level names at import time — patching
    # videos_module's attributes alone would not reach them.
